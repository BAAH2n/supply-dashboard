...
# ===============================================
# ⚠️ ВАЖЛИВО ДЛЯ ПЕРШОГО ЗАПУСКУ:
# Якщо це перший раз, запустіть цей chunk ОКРЕМО в R Console (Ctrl+Enter в RStudio)
# Відкриється браузер для авторизації Google Sheets
# Після авторизації токени збережуться і можна буде робити quarto render

cat("📥 Завантаження даних з Google Sheets...\n")
...
cat("✅ Дані завантажено!\n")
cat("🔄 Трансформація даних...\n")
