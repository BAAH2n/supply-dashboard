...
# Автентифікація через браузер (інтерактивна)
# При першому запуску відкриється браузер для авторизації
googlesheets4::gs4_auth(
  email = TRUE,  # Дозволить вибрати email
  cache = ".secrets"  # Зберігає токени в папці .secrets
)

cat("✅ Автентифікація успішна!\n\n")
```
